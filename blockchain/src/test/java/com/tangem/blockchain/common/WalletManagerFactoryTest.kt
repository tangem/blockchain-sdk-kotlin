        ...
        return WalletManagerFactory(
            BlockchainSdkConfig(
                ...
                getBlockCredentials = GetBlockCredentials(
                    ...
                    arbitrum = GetBlockAccessToken(),
                    bitcoinCash = GetBlockAccessToken(),
                    kusama = GetBlockAccessToken(),
                    moonbeam = GetBlockAccessToken(),
                    optimism = GetBlockAccessToken(),
                    polkadot = GetBlockAccessToken(),
                    shibarium = GetBlockAccessToken(),
                    sui = GetBlockAccessToken(),
                    telos = GetBlockAccessToken(),
                    tezos = GetBlockAccessToken(),
                    ink = GetBlockAccessToken(),
                    lisk = GetBlockAccessToken(),
                    soneium = GetBlockAccessToken(),
                    mode = GetBlockAccessToken(),
                    unichain = GetBlockAccessToken(),
                    celo = GetBlockAccessToken(),
                    fraxtal = GetBlockAccessToken(),
                ),
                tronGridApiKey = "",

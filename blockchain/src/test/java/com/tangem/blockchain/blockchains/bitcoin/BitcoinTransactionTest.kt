...
class BitcoinTransactionTest {
    ...
    fun buildCorrectTransaction() {
        ...
        val expectedHashToSign1 = "6331B5F57715E9E47A46527D39400689804A5223C19246F35B04BCEECB0F6AC3"
            .hexToBytes().toList()
        val expectedSignedTransaction = (
            "0100000001B6A2673BDD04D57B5560F4E46CAC3C1F" +
                "974E41463568F2A11E7D3175521D9C6D0000000" +
                "08B48304502210088E322D377878E83F25FD2E25" +
                "8344F0A7CC401654BF71C43DF96FC6B46766CAE022" +
                "030E97BD9018E9B2E918EF79E15E2747D4E00C55D69F" +
                "A0B8ADFAFD07F41144F81014104E3F3BE3CE3D8284DB3B" +
                "A073AD0291040093D83C11A277B905D5555C9EC41073E103F4D9D" +
                "299EDEA8285C51C3356A8681A545618C174251B984DF841F49" +
                "D2376F0000000002809698000000000017A91420C5D650F5A66352A0" +
                "D07C526D5738586F09E2DF874037FDD3E8000000160014D95DCA4F06B" +
                "1F60BEE334ECDDA515E51DD6593CF00000000"
            ).hexToBytes()
    ...
    fun buildCorrectMultisigTransaction() {
        ...
        val expectedHashToSign1 = "D953D5003BDA78F45EF55D46B6E43B01924D791222261892A33235B957E6622F"
            .hexToBytes().toList()
        val expectedHashToSign2 = "B4C32C6E8403B58AACB15299BD98A6A7A6EE6F135755AA89E5242EBA8F8F08D5"
            .hexToBytes().toList()
        val expectedSignedTransaction = (
            "01000000000102B6A2673BDD04D57B5560F4E46CAC3C1F974E41463568F2A11E7D3175521D9C6D000" +
                "000009200483045022100B8ADFAFD07F41144F81ECC780157EA9D44DC41D0BCB420175A5D3F54307" +
                "9F42602203AA2DBDE0EE2D388E322D37784424B13B98BB2C3645744A696AD2696FC6B467601475121028" +
                "5D520C8B907F0BC5E03FCBBAC212CCD270764BBFF4990A28653A2FB0D656C342103D2B9FB288540D54E5B3" +
                "2ECAF0381CD571F97F6F1ECD036B66BB11AA52FFE998152AE000000003F86D67DC12F3E3E7EE47E3B02D30D" +
                "476823B594CBCABF1123A8C272CC91F2AE490000000000000000010010A5D4E80000001976A9147C7446EC6" +
                "D27F4093D51CAFE09BC5F29BF6C806388AC00030047304402206CAE30E97BD9018E9B2E918EF79E878E83F25FD2" +
                "E258344F0A7CC401654BF71C022043DF337D7F3BD0798D66FDCE04B07C30915E2747D4E00C55D69FA03A877FC58301" +
                "4751210285D520C8B907F0BC5E03FCBBAC212CCD270764BBFF4990A28653A2FB0D656C342103D2B9FB288540D54E5B3" +
                "2ECAF0381CD571F97F6F1ECD036B66BB11AA52FFE998152AE00000000"
            ).hexToBytes()

...
class BinanceAddressTest {

    private val addressService = BinanceAddressService()

    @Test
    fun makeAddressFromCorrectPublicKey() {
        val walletPublicKey = (
            "04E3F3BE3CE3D8284DB3BA073AD0291040093D83C11A277B905D5555C9EC41073E103F4D9D299EDEA8285C51C3356A8681A545" +
                "618C174251B984DF841F49D2376F"
            ).hexToBytes()

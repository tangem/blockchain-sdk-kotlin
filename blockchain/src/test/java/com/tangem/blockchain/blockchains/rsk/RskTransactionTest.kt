...
class RskTransactionTest {
    ...
    fun buildCorrectCoinTransaction() {
        ...
        val expectedSignedTransaction =
            "F86C0F856EDF2A079E825208947655B9B19FFAB8B897F836857DAE22A1E7F8D73588016345785D8A0000805FA0C0FBC3255442CAE582FDC3CF8F431AAAB0B89D1D0DFBDAE71FEE44F99E4C11BDA03D31BEB446589EDC761493C369CDA6B13AC09D122C58C7F5903832678371A96D"
                .hexToBytes()
    ...
    fun buildCorrectTokenTransaction() {
        ...
        val walletPublicKey =
            "04EB30400CE9D1DEED12B84D4161A1FA922EF4185A155EF3EC208078B3807B126FA22C335081AAEBF161095C11C7D8BD550EF8882A3125B0EE9AE96DDDE1AE743F"
                .hexToBytes()
        val signature =
            "3057FEA6F18CC08553F79E985646262E06C0ED50DB7583D236958AB3ADB5D71333D1A8395CD286AF65FB781A2C2461132A9F34014CCDC68586B8F458848F4717"
                .hexToBytes()
        val sendValue = "0.1".toBigDecimal()
        val feeValue = "0.01".toBigDecimal()
        val destinationAddress = "0x7655b9b19ffab8b897f836857dae22a1e7f8d735"
        ...
        val expectedHashToSign = "92BC71B08CA63D69502BFF60E16282A603CFCD987A3C1C36062CD602D66C376B"
            .hexToBytes()
        val expectedSignedTransaction =
            ""
                .hexToBytes()

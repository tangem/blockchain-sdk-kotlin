...
class TronAddressTest {
    ...
    fun makeAddressFromCorrectPublicKey() {
        val walletPublicKey = (
            "0404B604296010A55D40000B798EE8454ECCC1F8900E70B1ADF47C9887625D8BAE3866351A6FA0B5370623268410D33D345F633" +
                "44121455849C9C28F9389ED9731"
            ).hexToBytes()
    ...
    fun makeAddressFromCompressedPublicKey() {
        val walletPublicKey = "034c88a1a83469ddf20d0c07e5c4a1e7b83734e721e60d642b94a53222c47c670d".hexToBytes()

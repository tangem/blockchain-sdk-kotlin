...
import com.tangem.blockchain.blockchains.bitcoin.*
...
class DashTransactionTest {

    private val blockchain = Blockchain.Dash
    private val networkParameters = DashMainNetParams()

    @Test
    fun buildCorrectTransaction() {
        // arrange
        val walletPublicKey = "0441DCD64B5F4A039FC339A16300A833A883B218909F2EBCAF3906651C76842C45E3D67E8D2947E6FEE8B62D3D3B6A4D5F212DA23E478DD69A2C6CCC851F300D80"
            .hexToBytes()
        ...
        val destinationAddress = "Xs92pJsKUXRpbwzxDjBjApiwMK6JysNntG"

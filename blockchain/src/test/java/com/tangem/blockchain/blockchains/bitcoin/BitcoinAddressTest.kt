...
class BitcoinAddressTest {
    ...
    fun makeMultisigAddressesFromCorrectPublicKeys() {
        val walletPublicKey1 = "04752A727E14BBA5BD73B6714D72500F61FFD11026AD1196D2E1C54577CBEEAC3D11FC68A64700F8D533F4E311964EA8FB3AA26C588295F2133868D69C3E628693"
                .hexToBytes()
        val walletPublicKey2 = "04E3F3BE3CE3D8284DB3BA073AD0291040093D83C11A277B905D5555C9EC41073E103F4D9D299EDEA8285C51C3356A8681A545618C174251B984DF841F49D2376F"
                .hexToBytes()
        val expectedSize = 2
        ...
        val addresses = addressService.makeAddresses(walletPublicKey1.wrapInObject(), walletPublicKey2)
        val addressesReverseOrder = addressService.makeAddresses(walletPublicKey2.wrapInObject(), walletPublicKey1)
        ...
        Truth.assertThat(addresses.map { it.value }).isEqualTo(addressesReverseOrder.map { it.value })

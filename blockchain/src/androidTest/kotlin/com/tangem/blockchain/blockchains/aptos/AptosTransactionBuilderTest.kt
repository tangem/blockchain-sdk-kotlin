...
internal class AptosTransactionBuilderTest {
    ...
    fun buildForSign() {
        ...
        val actual = txBuilder.buildForSign(
            ...
            transactionData = TransactionData.Uncompiled(
                amount = APT_AMOUNT.copy(value = BigDecimal.ONE),
                fee = Fee.Aptos(
    ...
    fun buildForSend() {
        ...
        val actual = txBuilder.buildForSend(
            ...
            expirationTimestamp = 1707145265,
            signature = (
                "B5E97DB07FA0BD0E5598AA3643A9BC6F6693BDDC1A9FEC9E674A461EAA00B1931869B853768F0BA935D67F837A66B172DD3" +
                    "9A60CA2315F8D4E0E669BBD35CF25010000000000000002000000000000000000000000000000000000000000000000" +
                    "00000000000000010D6170746F735F6163636F756E74087472616E7366657200022007968DAB936C1BAD187C60CE408" +
                    "2F307D030D780E91E694AE03AEF16ABA73F300800E1F505000000000900000000000000640000000000000031F8C065" +
                    "0000000001"
                )
                .hexToBytes(),
        )

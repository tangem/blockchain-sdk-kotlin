...
class CosmosTransactionTest {
    ...
    fun testBuildForSign() {
        ...
        val expected = byteArrayOf(
            45, 2, 116, -20, -35, -15, -125, 119, 12, 92, 28, -100, -95, -28, 104, 119, 99, -72, -53, 70, -83, -123,
            -102, -89, -61, -103, 34, -19, 52, 101, 63, -20,
        )
    ...
    fun testBuildForSend() {
        ...
        val expected = "{\"mode\":\"BROADCAST_MODE_SYNC\",\"tx_bytes\":\"CpEBCo4BChwvY29zbW9zLmJhbmsudjFiZXRhMS5Nc2d" +
            ...
            "RIjCiEC2LwhuZNV2HsWw9gvF5DQSqzVV7U4o6chOev04UdvMRoSBAoCCAEYEBITCg0KBXVhdG9tEgQyNzE3EJzRBhpAQRrqEpCG/Pxo" +

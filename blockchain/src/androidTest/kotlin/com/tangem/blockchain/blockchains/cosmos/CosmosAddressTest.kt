...
class CosmosAddressTest {
    ...
    fun testAddressValidation1() {
        ...
        val walletPublicKey = "038C869947BB27B78D36F2D60158CAF295EA874943D9574DC9C2228DB152D9A1C2"
            .hexToBytes()
    ...
    fun testAddressValidation2() {
        ...
        val walletPublicKey = "02D8BC21B99355D87B16C3D82F1790D04AACD557B538A3A72139EBF4E1476F311A"
            .hexToBytes()

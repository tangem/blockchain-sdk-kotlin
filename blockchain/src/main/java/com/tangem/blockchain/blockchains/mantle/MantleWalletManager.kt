...
import com.tangem.blockchain.common.TransactionData.Uncompiled
...
class MantleWalletManager(
            ...
            .map {
                when (it) {
                    is TransactionFee.Single -> {
                        ...
                        it.copy(normal = mapFeeEstimate(fee))
                    }
                    is TransactionFee.Choosable -> {
                        ...
                        TransactionFee.Choosable(
                            normal = mapFeeEstimate(normalFee),
                            minimum = mapFeeEstimate(minimumFee),
                            priority = mapFeeEstimate(priorityFee),
                        )
                    }
                }
            }
            ...
            is TransactionData.Uncompiled -> {
                ...
                super.sign(
                    transactionData = transactionData.copy(
                        ...
                        fee = patchedFee,
                        // the presence of extras is a workaround for correct gasPrice calculation
    ...
    private fun mapFeeEstimate(fee: Fee.Ethereum): Fee {
        return fee.copy(

...
enum class Chain(val id: Int, val blockchain: Blockchain?) {
    ...
    QuaiTestnet(id = 15000, blockchain = Blockchain.QuaiTestnet),
    Ink(id = 57073, blockchain = Blockchain.Ink),
    InkTestnet(id = 763373, blockchain = Blockchain.InkTestnet),
    Lisk(id = 1135, blockchain = Blockchain.Lisk),
    LiskTestnet(id = 4202, blockchain = Blockchain.LiskTestnet),
    Mode(id = 34443, blockchain = Blockchain.Mode),
    ModeTestnet(id = 919, blockchain = Blockchain.ModeTestnet),
    SwellChain(id = 1923, blockchain = Blockchain.SwellChain),
    SwellChainTestnet(id = 19230, blockchain = Blockchain.SwellChainTestnet),
    Superseed(id = 5330, blockchain = Blockchain.Superseed),
    SuperseedTestnet(id = 53302, blockchain = Blockchain.SuperseedTestnet),
    Bob(id = 60808, blockchain = Blockchain.Bob),
    BobTestnet(id = 808813, blockchain = Blockchain.BobTestnet),
    Soneium(id = 1868, blockchain = Blockchain.Soneium),
    SoneiumTestnet(id = 1946, blockchain = Blockchain.SoneiumTestnet),
    Unichain(id = 130, blockchain = Blockchain.Unichain),
    UnichainTestnet(id = 1301, blockchain = Blockchain.UnichainTestnet),
    MetalL2(id = 1750, blockchain = Blockchain.MetalL2),
    MetalL2Testnet(id = 1740, blockchain = Blockchain.MetalL2Testnet),
    Celo(id = 42220, blockchain = Blockchain.Celo),
    CeloTestnet(id = 11142220, blockchain = Blockchain.CeloTestnet),
    Fraxtal(id = 252, blockchain = Blockchain.Fraxtal),
    FraxtalTestnet(id = 2522, blockchain = Blockchain.FraxtalTestnet),
}
...
enum class Chain(val id: Int, val blockchain: Blockchain?) {
    ...
    Monad(id = 143, blockchain = Blockchain.Monad),
    MonadTestnet(id = 10143, blockchain = Blockchain.MonadTestnet),
    ...
    Linea(id = 59144, blockchain = Blockchain.Linea),
    LineaTestnet(id = 59141, blockchain = Blockchain.LineaTestnet),
    ...
    Berachain(id = 80094, blockchain = Blockchain.Berachain),
    BerachainTestnet(id = 80069, blockchain = Blockchain.BerachainTestnet),
}
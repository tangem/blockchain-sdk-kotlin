...
public class KaspaCashAddr {
    ...
    public static final String MAIN_NET_PREFIX = "kaspa";

    public static final String TEST_NET_PREFIX = "kaspatest";
    ...
    private static KaspaAddressType getAddressTypeFromVersionByte(byte versionByte) {
        for (KaspaAddressType addressType : KaspaAddressType.values()) {

...
sealed class TronNetwork(val url: String) {
    ...
    data class NowNodes(val apiKey: String) :
        TronNetwork(url = "https://trx.nownodes.io/${apiKey}")

    data class GetBlock(val apiKey: String) :
        TronNetwork(url = "https://trx.getblock.io/mainnet/${apiKey}")

...
class KaspaFeesCalculator(
    ...
    suspend fun estimateFee(
        ...
        return callEstimateFee(buildTransactionResult)
    }
    ...
    private suspend fun callEstimateFee(buildTransactionResult: Result<KaspaTransaction>): Result<KaspaFeeEstimation> {

...
internal data class MoralisEvmNFTAssetResponse(
    ...
    @Json(name = "normalized_metadata") val normalizedMetadata: NormalizedMetadata?,
) {
    @JsonClass(generateAdapter = true)
    ...
    internal data class Media(
        ...
        @Json(name = "media_collection") val mediaCollection: MediaCollection?,
        @Json(name = "original_media_url") val originalMediaUrl: String?,
    )

    @JsonClass(generateAdapter = true)
    data class MediaCollection(
        @Json(name = "low") val low: MediaDetail?,
        @Json(name = "medium") val medium: MediaDetail?,
        @Json(name = "high") val high: MediaDetail?,
    )

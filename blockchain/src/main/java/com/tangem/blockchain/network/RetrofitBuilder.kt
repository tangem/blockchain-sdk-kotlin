...
object BlockchainSdkRetrofitBuilder {
    ...
    internal fun build(internalInterceptors: List<Interceptor> = emptyList()): OkHttpClient {
        ...
        (interceptors + internalInterceptors).forEach(builder::addInterceptor)
        timeoutConfig?.let {
...
const val API_HEDERA_ARKHIA_MIRROR = "https://starter.arkhia.io/hedera/mainnet/api/v1/"
const val API_HEDERA_ARKHIA_MIRROR_TESTNET = "https://starter.arkhia.io/hedera/testnet/api/v1/"
const val API_ALEPHIUM_TANGEM = "https://alephium-tangem-7c3be5.alephium.org/"
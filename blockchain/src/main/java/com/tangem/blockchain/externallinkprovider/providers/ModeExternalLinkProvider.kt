...
internal class ModeExternalLinkProvider(isTestnet: Boolean) : ExternalLinkProvider {

    override val explorerBaseUrl: String =
        if (isTestnet) "https://sepolia.explorer.mode.network/" else "https://explorer.mode.network/"

    override val testNetTopUpUrl: String? = if (isTestnet) "https://docs.mode.network/tools/faucet" else null

...
internal class InkExternalLinkProvider(isTestnet: Boolean) : ExternalLinkProvider {

    override val explorerBaseUrl: String =
        if (isTestnet) "https://explorer-sepolia.inkonchain.com/" else "https://explorer.inkonchain.com/"

    override val testNetTopUpUrl: String? = if (isTestnet) "https://docs.inkonchain.com/general/faucet" else null

...
internal class LiskExternalLinkProvider(isTestnet: Boolean) : ExternalLinkProvider {

    override val explorerBaseUrl: String =
        if (isTestnet) "https://sepolia-blockscout.lisk.com/" else "https://blockscout.lisk.com/"

    override val testNetTopUpUrl: String? = if (isTestnet) "https://sepolia-faucet.lisk.com/" else null

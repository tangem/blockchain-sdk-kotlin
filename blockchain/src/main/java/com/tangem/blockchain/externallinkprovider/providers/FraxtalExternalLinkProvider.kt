...
internal class FraxtalExternalLinkProvider(isTestnet: Boolean) : ExternalLinkProvider {

    override val explorerBaseUrl: String =
        if (isTestnet) "https://holesky.fraxscan.com/" else "https://fraxscan.com/"

    override val testNetTopUpUrl: String? = null
